%  fcl kmeans fit
% 
%  [ C ]    = fcl_kmeans_fit(X, k, opts) returns the cluster center matrix C.
%
%  [ C, T ] = fcl_kmeans_fit(X, k, opts) returns internal information about the algorithm (explanation see below).
%
%  Input:
