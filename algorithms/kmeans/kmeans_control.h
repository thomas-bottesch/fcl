...
#define NO_KMEANS_ALGOS                      UINT32_C(7)
#define ALGORITHM_KMEANS                     UINT32_C(0)
#define ALGORITHM_KMEANS_OPTIMIZED           UINT32_C(1)
#define ALGORITHM_YINYANG                    UINT32_C(2)
#define ALGORITHM_FAST_YINYANG               UINT32_C(3)
#define ALGORITHM_MINIBATCH_KMEANS           UINT32_C(4)
#define ALGORITHM_MINIBATCH_KMEANS_OPTIMIZED UINT32_C(5)
#define ALGORITHM_ELKAN_KMEANS               UINT32_C(6)
#define ALGORITHM_KMEANS_OPTIMIZED_ONDEMAND  UINT32_C(7)
#define ALGORITHM_FAST_YINYANG_ONDEMAND      UINT32_C(8)
